...
public static partial class OptionExtensions
{
    ...
    {
        return option.Match(map, Option<TResult>.None);
    }
    ...
    public static AsyncOption<TResult> FlatMap<TValue, TResult>(
        this in Option<TValue> option,
        Func<TValue, AsyncOption<TResult>> map)
    {
        return option.Match(map, AsyncOption<TResult>.None);
    }
    ...
    public static Task<Option<TResult>> FlatMapAsync<TValue, TResult>(
        this in Option<TValue> option,
        Func<TValue, Task<Option<TResult>>> map)
    {
        return option.Match(map, () => Option<TResult>.None().AsTask());
    }
}